...
class DialogAddProduct(wx.Dialog):
    ...
    def __init__(self, parent, title, id_redact=None):
        ...
        self.path_img = "sys\\image\\default_pic.jpg"
        self.parent = parent
...
# ------------------------------------------------------------------------------
        ...
        # TODO Выбор фото для иконки из файлов пользователя
        self.image = wx.StaticBitmap(self.panel, wx.ID_ANY,
                                     wx.BitmapFromImage(self.path_img))
...
# ------------------------------------------------------------------------------
    ...
    def save_in_class(self):
        ...
        self.product.path_ico = "default_pic"
    ...
    def set_in_form_input(self, data):
        ...
        # TODO устанавливать выбранное пользователем фото
        # self.path_ico.SetValue(data[1])
